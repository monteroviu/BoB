...
class QuestionnairesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create questionnaire" do
    assert_difference('Questionnaire.count') do
      post questionnaires_url, params: { questionnaire: { code: @questionnaire.code, description: @questionnaire.description, name: @questionnaire.name, regards: @questionnaire.regards, thanks: @questionnaire.thanks } }
    end
  ...
  test "should update questionnaire" do
    patch questionnaire_url(@questionnaire), params: { questionnaire: { code: @questionnaire.code, description: @questionnaire.description, name: @questionnaire.name, regards: @questionnaire.regards, thanks: @questionnaire.thanks } }
