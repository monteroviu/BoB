...
class InvitationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create invitation" do
    assert_difference('Invitation.count') do
      post invitations_url, params: { invitation: { Group_id: @invitation.Group_id, Questionnaire_id: @invitation.Questionnaire_id, Student_id: @invitation.Student_id } }
    end
  ...
  test "should update invitation" do
    patch invitation_url(@invitation), params: { invitation: { Group_id: @invitation.Group_id, Questionnaire_id: @invitation.Questionnaire_id, Student_id: @invitation.Student_id } }
